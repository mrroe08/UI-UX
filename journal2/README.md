...
Steam is a free application that allows users to purchase, download, and launch games through it. It is generally regarded as the best in its class and that is for good reason. The application is super **learnable**. It does this by separating tabs into simple features. You have Store, Library, Community, and your profile which shows up as your username. This makes it super easy to understand what you are clicking on and from there you get options for more features. Such as a search bar for the store, and your library. 
...
This app is also extremely **efficient**, downloads are simple and speedy (depending on your internet), purchasing something is **safe** and easy, and finally the app doesn't make you jump through hoops for anything. For example, you can search in the store by deals, genres, etc. Or you can search for exactly what you want. Additionally in your library, you can filter to things you have installed, all games in your library, or just the last few games you played. Let's say you just want to boot the app up and play a game, you have downloaded. Simply click "Library" and filter by the installed games. Then select your game and play. It really is that easy. This all makes the application very **efficient** and easy to use. Below you can see the store page.
